...
export const Message=async(req,res)=>{
  ...
  "where are you from": "I am designed for NIT Raipur students to help with college queries.",
  "who is your supervisor": "My project supervisor is Prof. Manju Pandey.",
  "who is the hod of mca": "The HOD of the MCA department is Dr. Tripti Swarnkar.",
  "faculty list": "Faculty members in MCA: Prof. Manju Pandey, Prof. T.K Das, Prof. Mou Dasgupta, Dr. Dibakar Saha, Prof. Shyam Sundar, and Prof. Naeem Ahmad.",
  "how many canteens are there in NIT Raipur": "There are three canteens in the NIT Raipur campus.",
  "what is nit raipur": "NIT Raipur is one of the premier national institutes offering engineering, technology, and computer application programs.",
  "where is nit raipur located": "NIT Raipur is located in GE Road, Raipur, Chhattisgarh.",
  "mca department info": "The MCA department at NIT Raipur offers a 3-year postgraduate program focused on software development, AI, databases, and advanced computing.",
